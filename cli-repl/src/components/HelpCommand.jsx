        ...
        <>
            <div>
                ...
                <ul style={{ listStyleType: 'none', marginLeft: '10px' }} >
                    ...
                    <li> - <b> fetch-price : </b> Firstly write fetch-price and press enter, then write "fetch-price [pair] in the input filed" - Fetches the current price of a specified cryptocurrency</li>
